...
Open `scripts/pipeline.R` and find the parameters block at the top:
...
::: {.callout-tip}
Try another: set `CONDITION <- "sleep_deprived"` to run the identical
Shank3-vs-WT comparison in the other condition, and re-run. Every plot and
table regenerates for the new subset.
:::
